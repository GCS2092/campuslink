...
export default function AdminDashboardScreen() {
  ...
  return (
    <>
      ...
      >
        <Text style={styles.greeting}>Tableau de bord administrateur</Text>
        ...
        <Card>
          ...
          <TouchableOpacity style={styles.menuRow} onPress={() => router.push('/admin/verifications')}>
            <Ionicons name="checkmark-circle" size={24} color="#2563eb" />
            <Text style={styles.menuText}>Vérifications en attente</Text>
            <Ionicons name="chevron-forward" size={20} color="#94a3b8" />
          </TouchableOpacity>
          <TouchableOpacity style={styles.menuRow} onPress={() => router.push('/admin/students')}>
            <Ionicons name="people" size={24} color="#2563eb" />
            <Text style={styles.menuText}>Étudiants</Text>
            <Ionicons name="chevron-forward" size={20} color="#94a3b8" />
          </TouchableOpacity>
          <TouchableOpacity style={styles.menuRow} onPress={() => router.push('/admin/class-leaders')}>
            <Ionicons name="school" size={24} color="#2563eb" />
            <Text style={styles.menuText}>Responsables de classe</Text>
            <Ionicons name="chevron-forward" size={20} color="#94a3b8" />
          </TouchableOpacity>
          <TouchableOpacity style={styles.menuRow} onPress={() => router.push('/admin/universities')}>
            <Ionicons name="business" size={24} color="#2563eb" />
            <Text style={styles.menuText}>Universités</Text>
            <Ionicons name="chevron-forward" size={20} color="#94a3b8" />
          </TouchableOpacity>
          <TouchableOpacity style={styles.menuRow} onPress={() => router.push('/admin/moderation')}>
