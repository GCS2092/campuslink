...
/// Écran de gestion des départements pour les administrateurs d'université
class UniversityAdminDepartmentsScreen extends StatefulWidget {
  const UniversityAdminDepartmentsScreen({super.key});

  @override
  State<UniversityAdminDepartmentsScreen> createState() => _UniversityAdminDepartmentsScreenState();
}

class _UniversityAdminDepartmentsScreenState extends State<UniversityAdminDepartmentsScreen> {
  ...
  Future<void> _loadDepartments() async {
    ...
    try {
      final departments = await _universityAdminService.getDepartments();
      setState(() {
  ...
  Future<void> _handleDelete(String departmentId, String departmentName) async {
    ...
    if (confirmed == true) {
      try {
        final result = await _universityAdminService.deleteDepartment(departmentId);
        if (mounted) {
