...
/// Écran de gestion des campus pour les administrateurs d'université
class UniversityAdminCampusesScreen extends StatefulWidget {
  const UniversityAdminCampusesScreen({super.key});

  @override
  State<UniversityAdminCampusesScreen> createState() => _UniversityAdminCampusesScreenState();
}

class _UniversityAdminCampusesScreenState extends State<UniversityAdminCampusesScreen> {
  ...
  Future<void> _loadCampuses() async {
    ...
    try {
      final campuses = await _universityAdminService.getCampuses();
      setState(() {
        _campuses = campuses;
        _isLoading = false;
      });
  ...
  Future<void> _handleDelete(String campusId, String campusName) async {
    ...
    if (confirmed == true) {
      try {
        final result = await _universityAdminService.deleteCampus(campusId);
        if (mounted) {
