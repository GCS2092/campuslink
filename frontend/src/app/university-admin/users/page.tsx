...
import { FiUser, FiUserCheck, FiUserX, FiLock, FiUnlock, FiCheck, FiX, FiClock, FiLogOut, FiArrowLeft } from 'react-icons/fi'
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 hidden sm:block">
                  Vérifier les comptes et gérer les bannissements de votre université
                </p>
              </div>
            </div>
            <button
