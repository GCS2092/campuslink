...
import { FiUser, FiUserCheck, FiUserX, FiUsers, FiMail, FiCalendar, FiLogOut, FiArrowLeft } from 'react-icons/fi'
...
export default function UniversityAdminClassLeadersPage() {
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 hidden sm:block">
                  Gérez les responsables de classe de votre université
                </p>
              </div>
            </div>
            <button
        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 text-center mt-6">
            ...
            <p className="text-gray-600 text-sm sm:text-base">
              {searchTerm || selectedActive
                ? 'Essayez de modifier vos critères de recherche.'
                : 'Il n\'y a pas encore de responsables de classe assignés dans votre université.'}
            </p>
          </div>
        ) : (
          <>
